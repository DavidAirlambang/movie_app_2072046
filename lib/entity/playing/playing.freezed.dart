...
class _$_PlayingMovie implements _PlayingMovie {
  ...
  @override
  String toString() {
    return 'PlayingMovie(adult: $adult, backdropPath: $backdropPath, genreIds: $genreIds, id: $id, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, posterPath: $posterPath, releaseDate: $releaseDate, title: $title, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
abstract class _PlayingMovie implements PlayingMovie {
  const factory _PlayingMovie(
      ...
      final bool? video,
      final double? voteAverage,
      final int? voteCount}) = _$_PlayingMovie;
